// ============================================================================
// KOP-XIAO Quantumult X Resource Parser - Safe Variant
// Based directly on the upstream parser. Core parsing logic is unchanged.
// Security change: sfilter/srename dynamic JavaScript execution is disabled.
// ============================================================================
...
var Psfilter = null; // SECURITY: sfilter disabled (no dynamic script execution)
...
var Psrename = null; // SECURITY: srename disabled (no dynamic script execution)
...
function FilterScript(servers, script) {
    // SECURITY: dynamic script filter disabled.
    // Keep function name/signature so the original parser flow remains compatible.
    return servers;
}
...
function RenameScript(servers, script) {
    // SECURITY: dynamic script rename disabled.
    // Keep function name/signature so the original parser flow remains compatible.
    return servers;
}
